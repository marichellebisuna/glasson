...
const Deal = () => {
  return (
    <div className='deal'><div className="left">
    ...
    <div className="count-down">
     <div className="timer">
     <div className="time"><span className='blue'>02</span>days</div>
     ...
     <div className="title"><h1 ><span style={{color:"red", fontWeight:"700"}}> Hot deal </span>this week</h1></div>
